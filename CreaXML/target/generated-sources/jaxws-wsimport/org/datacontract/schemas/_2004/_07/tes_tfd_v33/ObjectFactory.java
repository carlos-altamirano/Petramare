...
public class ObjectFactory {
    ...
    private final static QName _DetalleCancelacionUUID_QNAME = new QName("http://schemas.datacontract.org/2004/07/TES.TFD.V33.Negocios", "UUID");
    ...
    public JAXBElement<String> createDetalleCancelacionUUID(String value) {
        return new JAXBElement<String>(_DetalleCancelacionUUID_QNAME, String.class, DetalleCancelacion.class, value);
    }
    ...
    public JAXBElement<String> createTimbre33UUID(String value) {
        return new JAXBElement<String>(_DetalleCancelacionUUID_QNAME, String.class, Timbre33 .class, value);
    }
    ...
    public JAXBElement<String> createRegistroTimbreUUID(String value) {
        return new JAXBElement<String>(_DetalleCancelacionUUID_QNAME, String.class, RegistroTimbre.class, value);
    }
