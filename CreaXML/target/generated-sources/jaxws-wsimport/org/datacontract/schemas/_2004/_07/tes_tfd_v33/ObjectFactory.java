...
public class ObjectFactory {
    ...
    private final static QName _RespuestaReporteMensajeError_QNAME = new QName("http://schemas.datacontract.org/2004/07/TES.TFD.V33.Negocios", "MensajeError");
    ...
    public JAXBElement<String> createRespuestaReporteMensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaReporte.class, value);
    }
    ...
    public JAXBElement<String> createRespuestaEstatusCancelacionAsincronaMensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaEstatusCancelacionAsincrona.class, value);
    }
    ...
    public JAXBElement<String> createRespuestaValidacionRFCMensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaValidacionRFC.class, value);
    }
    ...
    public JAXBElement<String> createRespuestaCreditosMensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaCreditos.class, value);
    }
    ...
    public JAXBElement<String> createRespuestaTFD33MensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaTFD33 .class, value);
    }
    ...
    public JAXBElement<String> createRespuestaCancelacionMensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaCancelacion.class, value);
    }
    ...
    public JAXBElement<String> createRespuestaCancelacionAsincronaMensajeError(String value) {
        return new JAXBElement<String>(_RespuestaReporteMensajeError_QNAME, String.class, RespuestaCancelacionAsincrona.class, value);
    }
