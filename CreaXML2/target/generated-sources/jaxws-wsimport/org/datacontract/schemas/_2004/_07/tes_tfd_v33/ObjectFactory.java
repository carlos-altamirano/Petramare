...
public class ObjectFactory {
    ...
    private final static QName _RespuestaCancelacionAsincronaReferencia_QNAME = new QName("http://schemas.datacontract.org/2004/07/TES.TFD.V33.Negocios", "Referencia");
    ...
    public JAXBElement<String> createRespuestaCancelacionAsincronaReferencia(String value) {
        return new JAXBElement<String>(_RespuestaCancelacionAsincronaReferencia_QNAME, String.class, RespuestaCancelacionAsincrona.class, value);
    }
    ...
    public JAXBElement<String> createRespuestaEstatusCancelacionAsincronaReferencia(String value) {
        return new JAXBElement<String>(_RespuestaCancelacionAsincronaReferencia_QNAME, String.class, RespuestaEstatusCancelacionAsincrona.class, value);
    }
