                ...
                if (vector_info != null && !vector_info.equals("")) {
                    ...
                    if (vector_info.equals("vector_consulta")) {
                        ...
                        if (vector_consulta != null && vector_consulta_total != null) {
                            ...
                            correcto = Modelos.AuthorizationModel.generaArchivoDeConsulta(vector_consulta, "consulta_ejecutiva");
                    ...
                    if (vector_info.equals("movimientos_detalle")) {
                        ...
                        if (vector_consulta != null) {
                            correcto = Modelos.AuthorizationModel.generaArchivoDeConsulta(vector_consulta, "movimientos_detalle");
                            pdfFileName = "movimientos_detalle.csv";
                        }
                    }
                    if (vector_info.equals("descarga_saldos")) {
                            correcto = Modelos.AuthorizationModel.generaConsultaSaldos(request.getParameter("fechaFin"));
                    ...
                    if (vector_info.equals("movimientosPeriodo")) {
                        ...
                        if (vector_consulta != null) {
                            correcto = Modelos.AuthorizationModel.generaArchivoDeConsulta(vector_consulta, "consulta_periodo");
                            pdfFileName = "consulta_periodo.csv";
                        }
                    }
                } else {            
                    // Se actualiza el archivo que contiene el resultado de la consulta
                    correcto = Modelos.AuthorizationModel.actualizaArchivo();                    
                }
                if (correcto) {
