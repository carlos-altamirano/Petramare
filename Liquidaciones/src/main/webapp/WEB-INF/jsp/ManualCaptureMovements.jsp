                ...
                <form name="captureData" method="post" action="ControllerCapture">
                    ...
                    <c:if test="${ sessionScope.imprimeResumen==null }">
                        <table align="center" >
                                ...
                                <td>
                                    <table  align="center"  class="form-noindentCapture"  >
                                        ...
                                        <tr class="Subtitulo">
                                            ...
                                            <td align="left">
                                                <input type="text" name="RFC" id="rfc" maxlength="13" value="<c:out value='${sessionScope.RFC}'/>" style="width:150px;"/>
                                            </td>
                                        </tr>
                            ...
                            <tr align="center">
                                <td colspan="3">
                                    <input type="button" name="guardar" value="Cargar" id="cargarbtn" onClick="return guardarMovimiento(captureData, 'cargaMovimientoManual:2')"/>
                                    <input type="button" name="terminar" value="Finalizar" id="finalizarbtn" onClick="return setAction(captureData, 'almacenaLayOutManual:3')"/>
                                </td>
                            </tr>
                            ...
                            $(function(){
                                $('#rfc').keyup(function (){
                                    $.ajax({
                                        ...
                                        type:'POST',
                                        data:{accion:'validaRFC:9', rfc:$(this).val()},
                                        success:function(data){
                                            if (data.trim() !== "") {
                                                $('#cargarbtn').attr('disabled', 'disabled');
                                                $('#finalizarbtn').attr('disabled', 'disabled');
                                                alert(data.trim());
                                            } else {
                                                $('#cargarbtn').removeAttr('disabled');
                                                $('#finalizarbtn').removeAttr('disabled');
                                            }
                                        },
                                        error:function(info){
                                            console.log(info);
