...
//                        if(){
                        ...
                        case 4://Validación de CLAVE DE BANCO
                            ...
                            if (campo.matches(expresion)) {
                                try {
                                    ...
                                    if (!respuesta.isCancelado()) {
                                        if (!respuesta.isRFCLocalizado()) {
                                            ...
                                            desErrores[1] = "4";
                                            desErrores[2] = " RFC ";
                                            desErrores[3] = " " +campo+ " RFC no existe en el sat";
                                            errores.add(desErrores);
                                        }
                                    } else {
                                        desErrores = new String[4];
                                        ...
                                        desErrores[1] = "4";
                                        desErrores[2] = " RFC ";
                                        desErrores[3] = " " +campo+ " RFC cancelado por el sat";
                                        errores.add(desErrores);
                                    }
                                } catch(Exception e) {
                                    System.out.println("Error de conexion Web Service");
                                    desErrores = new String[4];
                                    desErrores[0] = line + "";
                                    desErrores[1] = "4";
                                    desErrores[2] = " RFC ";
                                    desErrores[3] = " " +campo+ " Error de RFC favor de intentarlo otra vez mas tarde ";
                                    errores.add(desErrores);
                                }
                            } else {
                                desErrores = new String[4];
                                ...
                                desErrores[1] = "4";
                                desErrores[2] = " RFC ";
                                desErrores[3] = " " +campo+ " El formato es incorrecto ";
                                errores.add(desErrores);
                            }
                            break;
