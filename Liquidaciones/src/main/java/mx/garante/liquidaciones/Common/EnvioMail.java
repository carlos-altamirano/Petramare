package mx.garante.liquidaciones.Common;
...
public class EnvioMail {
     ...
     */
    public static boolean enviaCorreo(String correoOrigen, String correoDestino, String asunto, String texto,String puerto) {
...
//            t.connect(correoOrigen, "liquidaciones");
     ...
     * y cuerpo del correo en formato HTML.
     * @param correoOrigen : Correo emisor.
     ...
     */
    public static boolean enviaCorreo(String correoOrigen, String correosDestino, String asunto, String cuerpo, String urlArchivo, String archivosAdjunto,String puerto) {
        boolean envio = false;
        Transport t = null;
        Properties props = null;
        String[] correos = null;
...
//            t.connect(correoOrigen, "liquidaciones");
            ...
            envio = false;
            System.out.println("Exception:enviaCorreoL puerto="+ puerto +  " :" + e.getMessage());
            // Cerramos las conexiones.
            try {
                if (t != null) {
                    t.close();
                ...
                System.out.println("Exception:enviaCorreoL_Close puerto="+ puerto +  " :" + ex.getMessage());
            }
        }
        return envio;
    }
    ...
    /**
     * Método que envia correo electrónico sin archivo adjunto para kiosco.
     *
     * @param correoOrigen : Correo emisor.
     * @param correoDestino : Correos destino.
     * @param asunto : Asunto del correo electrónico.
