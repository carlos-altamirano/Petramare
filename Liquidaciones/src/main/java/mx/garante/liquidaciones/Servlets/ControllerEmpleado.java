    ...
    public void enviaCorreoActivacion(Empleado empleado) {
        try {
            String html = "<h4>Hola " + empleado.getNombre() + " " + empleado.getAppat() + " " + empleado.getApmat() + " <br><br>Esta es la informaci&oacute;n con la cual podras ingresar al Kiosco recuperaci&oacute;n CFDI.</h4>\n" +
                ...
                html += "</tdoby>\n" +
                "    </table>";
            if (!EnvioMail.enviaCorreo2("kiosco@fideicomisogds.mx", empleado.getEmail(), "Kiosco recuperación CFDI", html, "587")) {
                Thread.sleep(180000);
                EnvioMail.enviaCorreo2("kiosco@fideicomisogds.mx", empleado.getEmail(), "Kiosco recuperación CFDI", html, "587");
            }
