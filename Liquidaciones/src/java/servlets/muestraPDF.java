...
//                            System.out.println("Nombre archivo= " + nombreArchivo);
                            String idArch_fechLiq = Modelos.ModeloLayOut.getClaveArchivo_nombreArchivo_fechaLiq(usuarioApp.getClave_contrato(), fechaBD, nombreArchivo);
                            String datos[] = null;
                            datos = idArch_fechLiq.split(";");
//                            for (String string : datos) {
//                                System.out.println("Dto:" + string);
//                            }                            
                            String fecha_corta = Modelos.ModeloLayOut.getFormatoFechaBaseDatos(datos[1]);
                            String nombre_archivo = Modelos.ModeloLayOut.getNombreResumenLiquidacion(usuarioApp.getClave_contrato(), fecha_corta, nombreArchivo, Integer.parseInt(datos[0]));
